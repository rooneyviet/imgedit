        ...
        <section className="grid grid-cols-1 gap-0 border-t border-l border-black/10 md:grid-cols-12">
          <article className="flex flex-col border-r border-b border-black/10 bg-stone-100 p-8 transition-colors hover:bg-stone-200 md:col-span-4">
            ...
            <Button
              ...
              className="h-auto rounded-none border-2 border-black py-4 font-mono text-xs font-bold tracking-[0.2em] uppercase transition-colors hover:bg-black hover:text-white disabled:opacity-50"
            >
          ...
          <article className="relative flex flex-col border-r border-b border-black/10 bg-white p-8 transition-colors hover:bg-stone-100 md:col-span-4">
            ...
            <Button
              ...
              className="h-auto rounded-none bg-linear-to-br from-[#a70070] to-[#d3008e] py-4 font-mono text-xs font-bold tracking-[0.2em] text-white uppercase transition-colors hover:from-[#8e005f] hover:to-[#b6007a] disabled:opacity-50"
            >
          ...
          <article className="relative flex flex-col border-r border-b border-black bg-[#1a1c1c] p-8 text-white transition-colors hover:bg-[#2a2c2c] md:col-span-4">
            ...
            <Button
              ...
              className="h-auto rounded-none bg-white py-4 font-mono text-xs font-bold tracking-[0.2em] text-black uppercase hover:bg-[#ffd8e7] disabled:opacity-50"
            >
